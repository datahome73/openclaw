...
RUN --mount=type=cache,id=s/f8e039dd-a3a2-44b3-b685-8696c5ccb223-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store \
...
RUN --mount=type=cache,id=s/f8e039dd-a3a2-44b3-b685-8696c5ccb223-/var/cache/apt,target=/var/cache/apt \
    --mount=type=cache,id=s/f8e039dd-a3a2-44b3-b685-8696c5ccb223-/var/lib/apt,target=/var/lib/apt \
    apt-get update && \
