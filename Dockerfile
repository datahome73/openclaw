...
RUN --mount=type=cache,id=s/2639aa1a-7a45-41c7-9922-c1b900c98cc4-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store \
...
RUN --mount=type=cache,id=s/2639aa1a-7a45-41c7-9922-c1b900c98cc4-/var/cache/apt,target=/var/cache/apt \
    --mount=type=cache,id=s/2639aa1a-7a45-41c7-9922-c1b900c98cc4-/var/lib/apt,target=/var/lib/apt \
    apt-get update && \
